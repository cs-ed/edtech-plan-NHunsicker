...
2. Wired computer mice will be available to students who would prefer not to use touchpads.

3. Use of a wall mounted television that will be used to display content for the entire class during discussions. A projector could also be used for this purpose.

4. A white board and accessories for writing pseudocode and making lists of ideas from discussions is also necessary.
